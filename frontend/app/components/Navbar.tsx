...
export default function Navbar()
{
    return(
        <div className="w-screen flex flex-row justify-between align-middle items-center pi:mx-3 2xl:mx-5">
            ...
            <button className="font-bold text-[#ffffff] pi:my-2 pi:p-2 pi:px-3 2xl:p-3 2xl:px-5 bg-indigo rounded-[30px] hover:opacity-70 pi:text-[18px] 2xl:text-[20px]">สร้างบัญชีใหม่</button>
        </div>
    );
}